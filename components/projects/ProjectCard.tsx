...
export function ProjectCard({ project }: { project: ProjectSummary }) {
  return (
    <Link
      ...
      className="flex flex-col gap-3 rounded-2xl border border-neutral-200 bg-white p-5 shadow-[0_20px_45px_rgba(8,60,32,0.05)] transition hover:-translate-y-1 hover:shadow-[0_35px_75px_rgba(8,60,32,0.1)]"
    >
